...
## 0.8.2 — 2026-09-14 · Bản thử lõi #2: 🧑‍🍳 Quầy POV kéo thả (tab Thêm → Mini)
Kent sau khi thử Ráp tô: "ok, nhưng kéo thả vô tô sẽ có cảm giác tương tác hơn; góc nhìn POV cái quầy prep". `src/pov.js` + overlay `#pov`:
- Màn góc nhìn thứ nhất, ba lớp sâu: **nồi trụng** (3 rọ + chỗ trữ tô nóng, hơi nước) và **bồn xả** ở xa; hàng **nồi nước lèo** (vá); **tủ prep** khay GN theo thứ tự kệ thật ở giữa; **mặt thớt** với chồng tô, bin sợi và **2 chỗ tô** đang ráp ở gần; phiếu khách kẹp trên đầu (tối đa 3, kiên nhẫn 90 s).
- Mọi thao tác là kéo thả (pointer events, ghost bám ngón, vùng thả sáng lên): tô sạch → nồi (trụng 0.7 s, trữ ≤5) → kéo tô nóng xuống chỗ tô; sợi → rọ (1.2 s) → rọ qua bồn (0.7 s) → rọ vô nồi trụng lại (0.6 s) → trút vô tô; topping/vá nước → tô; tô xong → kéo lên đúng phiếu. Kiến thức được kiểm ở chỗ thả: phở chưa xả lạnh mà trút vô tô, bún bò đem xả lạnh, sợi đang lạnh, sai thứ tự topping, giao nhầm phiếu — đều báo và rung nhẹ. Tô hợp lệ khi các bước đã bỏ là tiền tố chuỗi ráp của ít nhất một phiếu đang treo (làm song song 2 tô, giao cho phiếu nào khớp).
- Lỗi tính theo TÔ, khi giao cộng vào phiếu nhận. Kết quả cùng dạng puzzle (mastery/progress dùng chung). Món hợp lệ như Ráp tô (`povOk`: phở tái nạm, bún riêu, bún bò Huế).
