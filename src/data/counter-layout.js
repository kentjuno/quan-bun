...
export const ZONES = {
  pot:    { x: 10.5, y:   24, w:   25, h:   11 },   // đúng lòng nồi: quai rổ nhô lên trên vành, cái rổ nằm trong nước
  hot:    { x:    5, y:   36, w:   33, h:    7 },   // tô nóng trữ ở mép nồi
  sink:   { x: 37.5, y:   28, w:   25, h:   15 },   // bồn xả lạnh
  burner: { x: 60.5, y: 28.5, w:   23, h: 13.5 },   // mặt bếp trái: 2 nồi nước (nồi đã xoá khỏi tranh)
  broth:  { x:   85, y:   30, w:   14, h:   11 },   // nước nấu sẵn ở đầu phải mặt bếp
  prep:   { x:    4, y: 43.5, w: 90.5, h:   11 },   // dải để khay — khay là sprite, số lượng tự giãn theo món
  fryer:  { x: 83.5, y:   28, w:   14, h: 13.5 },   // chảo chiên đứng đầu phải mặt bếp
  micro:  { x:   69, y: 13.5, w: 25.5, h:   12 },   // lò vi sóng trên kệ tường
  stack:  { x:    0, y:   56, w:   15, h:   20 },   // chồng tô + mẹt/dĩa
  noodle: { x:   12, y: 66.5, w:   26, h:   13 },   // khay sợi
  boards: { x:    0, y:   79, w:   30, h:   16 },   // thớt
  slots:  { x:   37, y:   69, w:   56, h:   26 },   // mặt thớt trắng — chỗ ráp tô
  trash:  { x: 82.5, y: 54.5, w: 16.5, h: 19.5 },
