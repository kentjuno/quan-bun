...
export const LEVELS = [
  ...
  { id: 11, name: 'Level 11 — Phở mới', seconds: 260, dishes: ['pho-ga', 'pho-sot-vang', 'pho-xao-lan'], moneyTargets: [150, 250, 350], arrivals: ARR_LONG },
];
...
export const SHELF_TOPPING = ['nam', 'bo-tai', 'la-sach', 'bo-vien', 'thit-luoc', 'bap-bo', 'cha-lua', 'cha-re', 'ca-chua', 'dau-hu', 'tom', 'hanh-tay', 'ngo-ri-ngo-gai', 'hanh-la', 'rau-ram',
  ...
  'nuoc-cot-chanh', 'dau-phong-rang', 'ot-do', 'mam-tom', 'mo-hanh', 'kinh-gioi', 'tia-to', 'bac-ha', 'goc-hanh-la', 'xa-lach', 'dua-leo', 'xoai', 'thit-nuong', 'do-chua', 'quay', 'chao-long', 'chao-suon', 'cha-gio', 'tom-luoc', 'sot-vang', 'rau-cai', 'ga-luoc'];
const FRYER_DISHES = ['cha-gio-viet-nam'];
const PREP_DISHES = ['cha-gio-viet-nam', 'goi-cuon-tom-thit', 'pho-tai-dap', 'pho-suon-tai', 'banh-da-cua', 'bun-ca-hai-phong', 'cha-ca-la-vong', 'bun-dau-mam-tom', 'banh-hoi-thit-heo', 'bun-cha-ha-noi', 'bun-nem-cua-thit-nuong-tom-nuong', 'bun-ga-nuong', 'chao-long', 'chao-suon', 'pho-ga'];
const BURNER_DISHES = ['bun-rieu-cua', 'bun-bo-hue', 'banh-da-cua', 'bun-ca-hai-phong', 'chao-long', 'chao-suon', 'pho-ga'];

// Bố trí bếp (lưới mét, gốc ở giữa sàn; +z hướng về phía khách/camera).
// type: shelf (kệ: items[]), pot (nồi trụng), sink (bồn xả), stove (bếp/nước lèo: broth = action chan),
//       stovetop (MẶT BẾP: nồi/chảo nhỏ — hâm sốt vang, xào lăn), counter (quầy ráp), serve (quầy giao), seat (ghế khách), trash
const STOVETOP_DISHES = ['pho-sot-vang', 'pho-xao-lan'];
...
export const KITCHEN_LANDSCAPE = {
  ...
  stations: [
    ...
    { id: 'stovetop',      type: 'stovetop',  label: 'Mặt bếp',    x: -3.0, z: 3.0, w: 0.8, d: 0.8, boards: 1, dishes: STOVETOP_DISHES },
...
export const KITCHEN_PORTRAIT = {
  ...
  stations: [
    ...
    { id: 'stovetop',      type: 'stovetop',  label: 'Mặt bếp',    x: 0.5,  z: -2.9, w: 0.8, d: 0.8, boards: 1, dishes: STOVETOP_DISHES },
