...
const ALLOW = [/src[\\/]data[\\/]i18n[\\/]/, /sim-data/, /src[\\/]data[\\/]worlds\.js$/, /src[\\/]data[\\/]customers\.js$/, /src[\\/]data[\\/]dishes[\\/]/, /src[\\/]data[\\/]game-extras\.js$/, /src[\\/]data[\\/]regions\.js$/, /src[\\/]config\.js$/, /src[\\/]game[\\/]dishlib\.js$/,
